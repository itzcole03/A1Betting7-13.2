...
class DataRequest(BaseModel):
    ...
    sport: Sport
    data_type: DataType
    date_range: Optional[List[date]] = Field(
        None, description="Date range [start, end]"
    )
...
class DataQualityMetrics(BaseModel):
    ...
    # Remove deprecated json_encoders; rely on Pydantic v2 default
    # serialization for datetime objects (ISO format).
...
class TeamData(BaseModel):
    ...
    # Pydantic v2 configuration (use default ISO datetime serialization)
    model_config = ConfigDict()
