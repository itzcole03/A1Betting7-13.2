...
async def get_analytics(
    ...
    **Returns:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Analytics request failed: {str(e)}"
        )
    ...
    **Returns:**
    ...
    try:
        request = AnalyticsRequest(
            ...
            time_frame=time_frame,
            sport=sport,
            filters={"model_id": model_id, "include_comparison": include_comparison},
        )
...
async def get_data_quality_analytics(
    ...
    **Returns:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Failed to get data quality analytics"
        )
...
async def get_business_intelligence(
    ...
    **Returns:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Failed to get business intelligence"
        )
...
async def get_active_alerts(
    severity: Optional[AlertSeverity] = Query(
        None, description="Alert severity filter"
    ),
    component: Optional[str] = Query(None, description="Component filter"),
...
async def export_analytics_report(
    ...
    **Returns:**
    ...
    """
    try:
        request = AnalyticsRequest(analytics_type=analytics_type, time_frame=time_frame)
