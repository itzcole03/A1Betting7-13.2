...
async def get_sportsbook_odds(
    ...
    **Returns:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Sportsbook request failed: {str(e)}"
        )


@integration_router.get(
    "/sportsbook/{sportsbook}/odds", response_model=IntegrationResponse
)
...
async def get_external_data(
    ...
    **Returns:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"External data request failed: {str(e)}"
        )
...
async def get_provider_data(
    ...
    **Returns:**
    ...
    try:
        request = ExternalDataRequest(
            provider=provider, data_type=data_type, sport=sport, real_time=real_time
        )
...
async def find_arbitrage_opportunities(
    ...
    **Returns:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Failed to find arbitrage opportunities"
        )
...
async def get_integration_status(
    ...
    integration_type: Optional[IntegrationType] = Query(
        None, description="Integration type filter"
    ),
    service: UnifiedIntegrationService = Depends(get_integration_service),
):
    """
