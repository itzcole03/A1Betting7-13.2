...
class PropValue:
    ...
    book_name: str
    confidence: float = 0.75
    kelly_fraction: float = 0.0  # Add kelly fraction for PropFinder compatibility
    ...
    def generate_complete_prop_analysis(self,
        ...
        try:
            ...
            return {
                ...
                "best_odds": {  # Add this key that PropFinder service expects
                    "best_over": best_over,
            ...
            return {
                ...
                "best_odds": {  # Add this key for compatibility
                    "best_over": None,
                    "best_under": None
                },
                "value_ranked": [],
