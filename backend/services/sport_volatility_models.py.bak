...
class VolatilityProfile:
    ...
    volatility_multiplier: (
        float  # Multiplier based on volatility (0.1 = very volatile, 2.0 = very stable)
    )
...
class SportVolatilityModels:
    ...
    def __init__(self):
        self.volatility_profiles: Dict[
            Tuple[SportType, DataCategory], VolatilityProfile
        ] = {}
        self.user_access_patterns: Dict[str, Dict[str, int]] = (
            {}
        )  # user_id -> {data_key: access_count}
    ...
    def _initialize_volatility_profiles(self):
        ...
        logger.info(
            f"✅ Initialized {len(self.volatility_profiles)} volatility profiles"
        )
    ...
    def _register_mlb_profiles(self):
        ...
        self.volatility_profiles[(SportType.MLB, DataCategory.LIVE_SCORES)] = (
            VolatilityProfile(
                sport=SportType.MLB,
        ...
        self.volatility_profiles[(SportType.MLB, DataCategory.LIVE_ODDS)] = (
            VolatilityProfile(
                sport=SportType.MLB,
        ...
        self.volatility_profiles[(SportType.MLB, DataCategory.PRE_GAME_ODDS)] = (
            VolatilityProfile(
                sport=SportType.MLB,
        ...
        self.volatility_profiles[(SportType.MLB, DataCategory.PLAYER_STATS)] = (
            VolatilityProfile(
                sport=SportType.MLB,
        ...
        self.volatility_profiles[(SportType.MLB, DataCategory.INJURY_REPORTS)] = (
            VolatilityProfile(
                sport=SportType.MLB,
    ...
    def _register_nba_profiles(self):
        ...
        self.volatility_profiles[(SportType.NBA, DataCategory.LIVE_SCORES)] = (
            VolatilityProfile(
                sport=SportType.NBA,
                data_category=DataCategory.LIVE_SCORES,
        ...
        self.volatility_profiles[(SportType.NBA, DataCategory.LIVE_ODDS)] = (
            VolatilityProfile(
                sport=SportType.NBA,
                data_category=DataCategory.LIVE_ODDS,
    ...
    def _register_nfl_profiles(self):
        ...
        self.volatility_profiles[(SportType.NFL, DataCategory.LIVE_SCORES)] = (
            VolatilityProfile(
                sport=SportType.NFL,
                data_category=DataCategory.LIVE_SCORES,
        ...
        self.volatility_profiles[(SportType.NFL, DataCategory.INJURY_REPORTS)] = (
            VolatilityProfile(
                sport=SportType.NFL,
                data_category=DataCategory.INJURY_REPORTS,
    ...
    def _register_nhl_profiles(self):
        ...
        self.volatility_profiles[(SportType.NHL, DataCategory.LIVE_SCORES)] = (
            VolatilityProfile(
                sport=SportType.NHL,
                data_category=DataCategory.LIVE_SCORES,
                base_ttl=40,
    ...
    async def get_dynamic_ttl(
        ...
        if profile_key not in self.volatility_profiles:
            logger.warning(
                f"⚠️ No volatility profile for {sport.value}:{data_category.value}, using default"
            )
        ...
        current_hour = datetime.now().hour
        game_state = (
            self.game_states.get(game_id, GameState.PRE_GAME) if game_id else None
        )
    ...
    async def track_user_access(
        self, user_id: str, sport: SportType, data_category: DataCategory
    ):
        ...
        if self.user_access_patterns[user_id][data_key] > 1000:
            self.user_access_patterns[user_id][
                data_key
            ] = 100  # Reset to reasonable number
    ...
    async def _invalidate_live_data_cache(self, game_id: str):
        ...
        try:
            ...
            patterns = [f"*live*{game_id}*", f"*odds*{game_id}*", f"*score*{game_id}*"]
    ...
    def get_volatility_summary(self) -> Dict[str, Any]:
        ...
        summary = {
            ...
            "sports_covered": len(
                set(sport for sport, _ in self.volatility_profiles.keys())
            ),
            "data_categories_covered": len(
                set(category for _, category in self.volatility_profiles.keys())
            ),
