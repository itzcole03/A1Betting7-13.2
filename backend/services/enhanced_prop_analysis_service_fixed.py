...
class EnhancedPropAnalysisService:
        ...
        try:
            ...
            for i, game_result in enumerate(recent_games[-10:]):
                ...
                performance_value = min(
                    1.0,
                    game_result.get("stat_value", 0)
                    / max(1, game_result.get("target_line", 1)),
                )
            ...
            if season_avg:
                statistics.append(StatisticPoint(label="Season Avg", value=season_avg))
            ...
            if vs_opponent_avg:
                statistics.append(StatisticPoint(label="vs Opp", value=vs_opponent_avg))
    ...
    async def _generate_ai_insights(
        ...
        try:
            ...
            trend_insights = await self._get_trend_insights(player_name, stat_type)
