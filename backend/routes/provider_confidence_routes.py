"""
Provider Confidence Integration API Routes

REST API endpoints for accessing provider confidence scores, selection results,
and integration status for enhanced odds aggregation decision making.
...
class IntegrationStatusResponse(BaseModel):
    ...
    selection_history_count: int
    confidence_thresholds: Dict[str, float]
    circuit_penalties: Dict[str, float]
...
def _convert_confidence_score_to_response(score: ProviderConfidenceScore) -> ProviderConfidenceResponse:
    ...
    return ProviderConfidenceResponse(
        ...
        circuit_state=score.circuit_state.value,
        provider_state=score.provider_state.value,
        success_rate_score=score.success_rate_score,
        latency_score=score.latency_score,
        freshness_score=score.freshness_score,
        reliability_score=score.reliability_score,
        consistency_score=score.consistency_score,
        circuit_penalty=score.circuit_penalty,
        adjusted_confidence=score.adjusted_confidence,
...
async def get_confidence_health():
    """
    Get health status of the provider confidence integration system.
    """
    try:
    ...
    try:
        ...
        return ProviderSelectionResponse(
            ...
            fallback_providers=[
                ...
                for score in result.fallback_providers
            ],
...
async def get_confidence_thresholds():
    """
    Get current confidence thresholds used for decision making.
    """
    try:
        integration = get_provider_confidence_integration()
