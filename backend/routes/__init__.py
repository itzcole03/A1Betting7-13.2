...
# Temporarily disable problematic imports to fix server startup
...
__all__ = [
    ...
    "auth_router",
    # "betting_router",  # Temporarily disabled
    "diagnostics_router",
    # "health_router",  # Temporarily disabled
    # "metrics_router",  # Temporarily disabled
    "mlb_extras_router",
    "mlb_extras",
    # "modern_ml_router",  # Temporarily disabled
    # "optimized_router",  # Temporarily disabled
    # "performance_router",  # Temporarily disabled
    # "prizepicks_router",  # Temporarily disabled
    # "propollama_router",  # Temporarily disabled
    # "user_router",  # Temporarily disabled
    # "enhanced_search_router",  # Temporarily disabled
]
