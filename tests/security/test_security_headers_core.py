...
class TestBasicSecurityHeaders:
    ...
    def test_hsts_header_enabled(self):
        ...
        settings = SecuritySettings(security_headers_enabled=True, enable_hsts=True)

        middleware = SecurityHeadersMiddleware(app=Mock(), settings=settings)
    ...
    def test_hsts_header_disabled(self):
        ...
        settings = SecuritySettings(security_headers_enabled=True, enable_hsts=False)
    ...
    def test_x_frame_options_deny(self):
        ...
        settings = SecuritySettings(
            security_headers_enabled=True, x_frame_options="DENY"
        )
    ...
    def test_x_frame_options_sameorigin(self):
        ...
        settings = SecuritySettings(
            security_headers_enabled=True, x_frame_options="SAMEORIGIN"
        )
...
class TestCSPFunctionality:
    ...
    def test_csp_upgrade_insecure_requests(self):
        ...
        settings = SecuritySettings(
            csp_enabled=True, csp_upgrade_insecure_requests=True
        )
    ...
    def test_csp_report_uri(self):
        ...
        settings = SecuritySettings(csp_enabled=True, csp_report_uri="/csp/report")
    ...
    def test_csp_enforce_mode(self):
        ...
        settings = SecuritySettings(
            security_headers_enabled=True, csp_enabled=True, csp_report_only=False
        )
    ...
    def test_csp_report_only_mode(self):
        ...
        settings = SecuritySettings(
            security_headers_enabled=True, csp_enabled=True, csp_report_only=True
        )
    ...
    def test_csp_disabled(self):
        ...
        settings = SecuritySettings(security_headers_enabled=True, csp_enabled=False)

        middleware = SecurityHeadersMiddleware(app=Mock(), settings=settings)

        response = Response()
        # dispatch is async; run it to avoid 'coroutine was never awaited' warnings
        asyncio.run(middleware.dispatch(Mock(), Mock()))  # Won't add CSP header
...
class TestCrossOriginPolicies:
    ...
    def test_coop_same_origin_allow_popups(self):
        ...
        settings = SecuritySettings(security_headers_enabled=True, enable_coop=True)
    ...
    def test_coop_disabled(self):
        """Test COOP disabled"""
        settings = SecuritySettings(security_headers_enabled=True, enable_coop=False)
    ...
    def test_coep_require_corp(self):
        ...
        settings = SecuritySettings(security_headers_enabled=True, enable_coep=True)
    ...
    def test_coep_disabled(self):
        """Test COEP disabled"""
        settings = SecuritySettings(security_headers_enabled=True, enable_coep=False)
    ...
    def test_corp_same_site(self):
        ...
        settings = SecuritySettings(security_headers_enabled=True, enable_corp=True)
    ...
    def test_corp_disabled(self):
        """Test CORP disabled"""
        settings = SecuritySettings(security_headers_enabled=True, enable_corp=False)
...
class TestPermissionsPolicy:
    ...
    def test_permissions_policy_basic(self):
        ...
        settings = SecuritySettings(
            security_headers_enabled=True, permissions_policy_enabled=True
        )
