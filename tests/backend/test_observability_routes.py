...
class TestObservabilityRoutes:
    ...
    def test_observability_snapshot_baseline_structure(self, client):
        ...
        required_keys = ["ev_ms_avg", "arbitrage_ms_avg", "odds_norm_ms_avg", "line_movement_ms_avg"]
    ...
    @patch('backend.routes.observability_routes.instrumentation_service.get_observability_snapshot')
    ...
    @patch('backend.routes.observability_routes.instrumentation_service.get_health_status')
