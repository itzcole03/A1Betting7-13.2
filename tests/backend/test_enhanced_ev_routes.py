...
from backend.services.enhanced_ev_engine import FeatureFlag, enhanced_ev_engine
...
def sample_ev_request():
    ...
    return {"fair_odds": 2.0, "market_odds": 2.2, "stakes": 10.0}
...
class TestEnhancedEVAPI:
    ...
    def test_batch_calculate_empty_request(self, client):
        ...
        empty_request = {"opportunities": [], "use_optimization": True}
...
class TestFeatureFlagAPI:
    ...
    def test_set_feature_flag_success(self, client):
        ...
        flag_request = {"flag": "enable_caching", "enabled": False}
    ...
    def test_set_invalid_feature_flag(self, client):
        ...
        flag_request = {"flag": "invalid_flag_name", "enabled": True}
...
class TestErrorHandling:
    ...
    @patch(
        "backend.services.enhanced_ev_engine.enhanced_ev_engine.compute_ev_enhanced",
...
class TestConcurrency:
    ...
    def test_concurrent_feature_flag_changes(self, client):
        ...
        def toggle_flag(enabled):
            flag_request = {"flag": "enable_caching", "enabled": enabled}
...
class TestRollingMetricsAPI:
    ...
    def test_rolling_metrics_with_data(self, client):
        ...
        test_request = {"fair_odds": 2.0, "market_odds": 2.2, "stakes": 10.0}
...
if __name__ == "__main__":
    ...
    pytest.main([__file__, "-v", "-k", "ev", "--tb=short"])
