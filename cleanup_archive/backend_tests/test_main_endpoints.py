...
# --- Dependency override for API key validation in tests ---
@pytest.fixture(autouse=True, scope="session")
def override_api_key_dependency():
    def always_valid_api_key(api_key: str = None):
        return api_key or "test_api_key"

    app.dependency_overrides[require_api_key] = always_valid_api_key
    yield
