...
async def test_phase_2_complete():
    ...
    try:
        ...
        from services.propollama_intelligence_service import (
            generate_propollama_intelligence,
        )
        ...
        print(
            f'   ✅ Advanced Ensemble Models: {len(analysis["model_consensus"])} models'
        )
        print(
            f'   ✅ Comprehensive Features: {analysis["feature_insights"]["total_features"]}+ features'
        )
        print(f"   ✅ PropOllama Intelligence: Advanced AI analysis")
        print(
            f'   ✅ Risk Assessment: {analysis["risk_assessment"]["risk_level"]} risk'
        )
