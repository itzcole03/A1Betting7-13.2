...
import { Target, Brain, Zap, Clock, CheckCircle, AlertCircle, Star, Activity } from 'lucide-react';
  ...
  return (
    <motion.div
      className={`
        ...
        ${isClickable ? 'cursor-pointer hover:border-cyan-500/50 transition-transform hover:scale-[1.03] active:scale-[0.97] focus-visible:scale-[1.03]' : ''}
...
export const PredictionSummaryCard = _PredictionSummaryCard;
export default _PredictionSummaryCard;
