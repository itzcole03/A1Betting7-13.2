...
function UnifiedSettingsAdminPage() {
  ...
  const { user } = useAuth();
  const _isAdmin = user?.role === 'admin' || user?.permissions?.includes('admin') || false;

  const _handleSettingChange = (key: keyof UserSettings, value: unknown) => {
  ...
  const _handleSystemRestart = async (service: string) => {
    try {
              ...
              <Card>
                ...
                <CardContent className='space-y-4'>
                  ...
                  <div>
                    // @ts-expect-error TS(17004): Cannot use JSX unless the '--jsx' flag is
                    provided... Remove this comment to see the full error message
                    <span id='risk-tolerance-label' className='text-sm font-medium'>
                      Risk Tolerance
                    </span>
                    // @ts-expect-error TS(17004): Cannot use JSX unless the '--jsx' flag is
                    provided... Remove this comment to see the full error message
                  ...
                  <div>
                    // @ts-expect-error TS(17004): Cannot use JSX unless the '--jsx' flag is
                    provided... Remove this comment to see the full error message
                    <label htmlFor='portfolio-size' className='text-sm font-medium'>
                      Portfolio Size ($)
                    </label>
                    // @ts-expect-error TS(17004): Cannot use JSX unless the '--jsx' flag is
                    provided... Remove this comment to see the full error message
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    provided... Remove this comment to see the full error message
                    <label
                      id='auto-stacking-label'
                      htmlFor='auto-stacking-switch'
                ...
                <CardContent className='space-y-4'>
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <label
                      ...
                      htmlFor='push-notifications-switch'
                      className='text-sm font-medium'
                    >
                      Push Notifications
                    </label>
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    provided... Remove this comment to see the full error message
                    <label
                      id='quantum-analysis-label'
                      htmlFor='quantum-analysis-switch'
                      className='text-sm font-medium'
                    >
                      Quantum Analysis (Beta)
                    </label>
                    // @ts-expect-error TS(17004): Cannot use JSX unless the '--jsx' flag is
                    provided... Remove this comment to see the full error message
                    <Switch
              ...
              <Card>
                ...
                <CardContent className='space-y-4'>
                  ...
                  <div>
                    // @ts-expect-error TS(17004): Cannot use JSX unless the '--jsx' flag is
                    provided... Remove this comment to see the full error message
                    <label htmlFor='primary-model-select' className='text-sm font-medium'>
                      Primary Model
                    </label>
                    // @ts-expect-error TS(17004): Cannot use JSX unless the '--jsx' flag is
                    provided... Remove this comment to see the full error message
                  ...
                  <div>
                    ...
                    <div className='mt-2 space-y-2'>
                      ...
                      <label
                        ...
                        htmlFor='advanced-explanations-checkbox'
                      >
                        // @ts-expect-error TS(17004): Cannot use JSX unless the '--jsx' flag is
                        provided... Remove this comment to see the full error message
                ...
                <Card key={platform}>
                  ...
                  <CardContent className='space-y-4'>
                    ...
                    <div className='flex items-center justify-between'>
                      // @ts-expect-error TS(17004): Cannot use JSX unless the '--jsx' flag is
                      provided... Remove this comment to see the full error message
                      <span id={`enable-platform-label-${platform}`} className='text-sm'>
                        Enable Platform
                      </span>
                      // @ts-expect-error TS(17004): Cannot use JSX unless the '--jsx' flag is
                      provided... Remove this comment to see the full error message
                  ...
                  <CardContent className='space-y-4'>
                    {Object.entries(apiKeys).map(([platform, key]) => (
                      ...
                      <div key={platform} className='space-y-2'>
                        ...
                        provided... Remove this comment to see the full error message
                        <label
                          htmlFor={`api-key-input-${platform}`}
