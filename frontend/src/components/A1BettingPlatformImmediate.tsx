...
import { useCommandSummary } from '../contexts/CommandSummaryContext';
...
const _A1BettingPlatformImmediate: React.FC = () => {
  ...
  const _activeItem = navigationItems.find(item => item.id === activeView);

  console.log('A1BettingPlatformImmediate render children:', {
    activeView,
    navigationItems,
    _ActiveComponent,
    _activeItem,
...
export default (props: unknown) => (
  <_CommandSummaryProvider>
    <_A1BettingPlatformImmediate {...props} />
  </_CommandSummaryProvider>
);
