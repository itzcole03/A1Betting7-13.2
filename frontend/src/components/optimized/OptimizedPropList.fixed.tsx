/**
 * Performance-Optimized PropList Component v3
 *
 ...
 * - Proper TypeScript interfaces matching existing components and FeaturedProp structure
 */
...
> => ({
  player: prop.player || '',
  team: '', // FeaturedProp doesn't have team, use empty string
  position: '', // FeaturedProp doesn't have position, use empty string
