...
import { Activity, Gauge, RefreshCw, Search, TrendingUp, Zap } from 'lucide-react';
import * as React from 'react';
import { Suspense, memo, useCallback, useEffect, useMemo, useState } from 'react';

import { useOptimizedList, useOptimizedPerformance } from '../../hooks/useOptimizedPerformance';
      ...
      >
        ...
        <div className='grid grid-cols-2 gap-4 mb-3'>
          ...
          <div>
            ...
            <p className='text-white font-semibold'>{opportunity.volume.toLocaleString()}</p>
          </div>
        </div>
...
const OptimizedPropFinderDashboard: React.FC = () => {
  ...
  const filteredOpportunities = useMemo(() => {
    ...
    let filtered = opportunities.filter(opp => {
      const matchesSearch =
        opp.player.toLowerCase().includes(searchTerm.toLowerCase()) ||
              ...
              <div className='bg-gray-800 rounded-lg border border-gray-700 p-4'>
                ...
                <div className='space-y-3'>
                  ...
                  <div>
                    ...
                    <p className='text-white'>
                      {selectedOpportunity.propType} {selectedOpportunity.line}
                    </p>
                  </div>
                  <div>
