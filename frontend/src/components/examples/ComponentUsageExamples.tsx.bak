...
import { ConfidenceBadge, ErrorDisplay, GlassCard, StatusBadge, TrendBadge } from '../shared';
        ...
        <div className='space-y-6'>
          ...
          <GlassCard variant='featured' padding='lg'>
            ...
            <p className='text-gray-400 mb-4'>
              Heavy ML explainability component with Chart.js visualizations, lazy-loaded for
              optimal performance.
            </p>
            <LazySHAPDashboard
              variant='dashboard'
          ...
          <GlassCard variant='featured' padding='lg'>
            ...
            <p className='text-gray-400 mb-4'>
              Complex prediction interface with real-time data, lazy-loaded to prevent blocking the
              main thread.
            </p>
        ...
        <div className='space-y-6'>
          ...
          <GlassCard variant='default' padding='lg'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <Spinner variant='brain' size='lg' tone='primary' label='Loading AI analysis...' />
              <Spinner
                variant='chart'
                size='lg'
                tone='success'
