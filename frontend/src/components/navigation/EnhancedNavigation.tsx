...
const EnhancedNavigation: React.FC<EnhancedNavigationProps> = ({ isOpen, onToggle, onClose }) => {
  ...
  const navigationItems: NavigationItem[] = [
    {
      ...
      href: '/',
      icon: Home,
      description: 'Your betting command center',
      category: 'main',
    },
    {
      id: 'propfinder',
      ...
      href: '/propfinder',
      icon: Search,
      description: 'Live prop opportunities and insights',
      category: 'main',
    },
    {
      id: 'ev-feed',
    ...
    },
    {
      ...
      href: '/arbitrage',
      icon: Target,
      description: 'Multi-sportsbook arbitrage finder',
      category: 'tools',
      isHot: true,
    },
    {
      ...
      href: '/line-shopping',
      icon: GitCompare,
      description: 'Compare every sportsbook to capture best odds',
      category: 'tools',
      isNew: true,
    },
    {
    ...
    },
    {
      ...
      icon: BarChart3,
      description: 'Calculate fair odds from projections',
      category: 'tools',
      isNew: true,
    },
    {
      ...
      href: '/smart-alerts',
      icon: Bell,
      description: 'AI-powered betting alerts',
      category: 'tools',
      isNew: true,
    },
    {
    ...
    },
    {
      ...
      href: '/bankroll',
      icon: Wallet,
      description: 'Manage bankroll and staking plans',
      category: 'analytics',
      isNew: true,
    },
  ];
      ...
      <div className='fixed top-4 left-20 z-[9999] hidden md:flex items-center space-x-3'>
        ...
        {isLocalAdmin && (
          <a
            ...
            role='button'
            aria-label='Admin'
            className='ml-2 inline-flex items-center px-3 py-1 rounded bg-slate-700 text-xs text-white hover:bg-slate-600 transition-colors'
          >
            Admin
          </a>
        )}
          ...
          <button
            ...
            onClick={() => {
              ...
              try {
                ...
                window.location.href = '/propfinder';
              }
            }}
          >
            Switch to User
                          ...
                          <div className='flex items-center space-x-3'>
                            <div
                              className={`p-2 rounded-lg transition-all ${
                                isCurrent ? 'bg-white/20' : 'bg-slate-800 group-hover:bg-slate-700'
                              }`}
                            >
                              <Icon className='w-4 h-4' />
                            </div>
