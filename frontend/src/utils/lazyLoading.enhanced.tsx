...
export const LazyComponents = {
  ...
  UserProfile: createLazyFeature(() => import('../components/user/UserProfile'), 'User Profile'),
  
  // Player Dashboard (Large feature)
  PlayerDashboard: createLazyRoute(() => import('../components/player/PlayerDashboardContainer'), 'Player Dashboard'),
  PlayerDashboardWrapper: createLazyFeature(() => import('../components/player/PlayerDashboardWrapper'), 'Player Dashboard'),
  
  // Betting Features
  BetSlip: createLazyFeature(() => import('../components/betting/BetSlip'), 'Bet Slip'),
  ArbitrageOpportunities: createLazyFeature(() => import('../components/betting/ArbitrageOpportunities'), 'Arbitrage'),
  OddsComparison: createLazyFeature(() => import('../components/odds/OddsComparison'), 'Odds Comparison'),
  
  // Analytics & ML
  MLModelCenter: createLazyFeature(() => import('../components/ml/MLModelCenter'), 'ML Models'),
  AnalyticsDashboard: createLazyFeature(() => import('../components/analytics/AnalyticsDashboard'), 'Analytics'),
  CheatsheetsDashboard: createLazyFeature(() => import('../components/cheatsheets/CheatsheetsDashboard'), 'Cheatsheets'),
  
  // Predictions
  PredictionDisplay: createLazyFeature(() => import('../components/prediction/PredictionDisplay'), 'Predictions'),
  
  // Admin
  AdminPanel: createLazyRoute(() => import('../components/admin/AdminPanel'), 'Admin Panel'),
  
  // Settings
  Settings: createLazyFeature(() => import('../components/settings/Settings'), 'Settings'),
